...
vehicle_file("/Database/Vehicle/radar/EWR_P_37.lua")
vehicle_file("/Database/Vehicle/radar/EWR_55Zh6U.lua")
vehicle_file("/Database/Vehicle/radar/EWR_1L119.lua")
vehicle_file("/Database/Vehicle/radar/EWR_GenericEW.lua")
vehicle_file("/Database/Vehicle/ERO_SA2_SNR75.lua")
vehicle_file("/Database/Vehicle/ERO_SA2_Trailer.lua")
vehicle_file("/Database/Vehicle/ERO_5S99_Trailer.lua")
vehicle_file("/Database/Vehicle/ERO_Toyota_ZU23.lua")
vehicle_file("/Database/Vehicle/ERO_Toyota_ZU23_Armored.lua")
--vehicle_file("/Database/Vehicle/ERO_Toyota_ZPU2.lua")
--vehicle_file("/Database/Vehicle/ERO_Toyota_ZPU2_Armored.lua")

...
local SA9M83 = {
	Name = SA9M83,
	display_name = _('9M83 S-300V (SA-12A Gladiator)'),
	display_name_short = _('9M83 S-300V (SA-12A Gladiator)'),
	name = "SA9M83",
	...
	t_marsh = 14.185, -- cruise time, 0.0 if not applicable
	...
	ModelData = { 
		...
		0, 			280000,	120000, 	0, 			0, 			0, 			0, 			-- thrust, newtons
...
GT_t.WS_t.S300V_9M83.LN[1].ECM_K = -1;
...
GT_t.WS_t.S300V_9M83.LN[1].beamWidth = 0;

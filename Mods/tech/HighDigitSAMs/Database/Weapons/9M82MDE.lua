...
local SA9M82ME = {
	Name = SA9M82ME, --SA9M82ME
	display_name = _('9M82MV S-300V4 (SA-23A Giant)'),
	name = "SA9M82ME",
	...
	M = 4682.0, -- Mass of the missile at launch
	...
	D_max = 304000.0, -- Maximum range firing at low altitude, in meters
	...
	ModelData = { 
		...
		1.3, 		4.9,	14.5, 		0, 			0, 			0, 			1000000000, -- time of stage, sec
		0, 			615.17,	51.95, 		0, 			0, 			0, 			0, 			-- fuel flow rate, kg/sec
		0, 			550000,	240000, 	0, 			0, 			0, 			0, 			-- thrust, newtons
...
GT_t.WS_t.Antey4000_9M82MDE.reference_angle_Z = math.rad(90)
GT_t.WS_t.Antey4000_9M82MDE.LN = {}
GT_t.WS_t.Antey4000_9M82MDE.LN[1] = {}

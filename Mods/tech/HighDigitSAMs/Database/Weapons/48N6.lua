...
local SA48N6 = {
	Cx_pil = 8,
	D_max = 55000, -- Maximum range firing at low altitude, in meters
	...
	M = 1800, -- Mass of the missile at launch
	...
	ModelData = { 
		...
		0, 			0, 		108.3, 		0, 			0, 			0, 			0, 			-- fuel flow rate, kg/sec
		0, 			0, 		220000, 	0, 			0, 			0, 			0, 			-- thrust, newtons

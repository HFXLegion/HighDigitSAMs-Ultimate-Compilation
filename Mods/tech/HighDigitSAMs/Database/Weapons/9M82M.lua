...
local SA9M82M = {
	...
	display_name = _('9M82M S-300VM (SA-23B Giant)'),
	display_name_short = _('9M82M S-300VM (SA-23B Giant)'),
	name = "SA9M82M",
	...
	M = 4685.0, -- Mass of the missile at launch
	H_max = 150000.0, -- Maximum target altitude
	H_min = 1000.0, -- minimum target altitude
	Diam = 1215.0, -- Missile diameter in cm
	Cx_pil = 8, -- "Cx like pendants" - Moment of inertia??
	D_max = 140000.0, -- Maximum range firing at low altitude, in meters
	...
	Mach_max = 6.8, -- maximum Mach of the missile
	t_b = 1.2, -- Motor start delay
	t_acc = 4.9, -- motor burn time
	t_marsh = 14.5, -- cruise time, 0.0 if not applicable
	...
	ModelData = { 
		...
		1.2, 		4.9,	14.5, 		0, 			0, 			0, 			1000000000, -- time of stage, sec
		0, 			615.17,	51.95, 		0, 			0, 			0, 			0, 			-- fuel flow rate, kg/sec
		0, 			450000,	220000, 	0, 			0, 			0, 			0, 			-- thrust, newtons
...
GT_t.WS_t.Antey2500_9M82M.LN[1].ECM_K = -1;
...
GT_t.WS_t.Antey2500_9M82M.LN[1].beamWidth = 0;

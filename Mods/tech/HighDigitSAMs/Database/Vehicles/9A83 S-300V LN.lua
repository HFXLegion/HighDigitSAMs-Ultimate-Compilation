...
GT.visual.shape = "ERO_9A83ME";
GT.visual.shape_dstr = "ERO_9A83ME_D";
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.S300V_9M83);
...
GT.Name = "S-300V 9A83 ln";
GT.DisplayName = _('SAM SA-12 S-300V "Gladiator" TEL B');
GT.DisplayNameShort = _('SA-12A');
GT.Rate = 10;

GT.DetectionRange  = 0;
GT.ThreatRange = GT.WS[1].LN[1].distanceMax;
GT.mapclasskey = "P0091000079";
GT.attribute = {wsType_Ground,wsType_SAM,wsType_Miss,S300V_9A83,
				"AA_missile",
				"SAM LL",
				};

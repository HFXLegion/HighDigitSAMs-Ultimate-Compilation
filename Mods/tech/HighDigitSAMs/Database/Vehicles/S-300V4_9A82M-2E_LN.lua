...
GT.visual.shape = "ERO_9A82ME";
GT.visual.shape_dstr = "ERO_9A82ME_D";
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.Antey4000_9M82MDE);
...
GT.Name = "S-300V4 9A82M-2E ln";
GT.DisplayName = _('SAM SA-23 S-300V4 "Giant" TEL A');
GT.DisplayNameShort = _('SA-23B S-300V4');
GT.Rate = 10;

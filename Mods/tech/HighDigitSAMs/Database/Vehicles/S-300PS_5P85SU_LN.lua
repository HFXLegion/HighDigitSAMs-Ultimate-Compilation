...
GT.visual.shape = "ERO_5P85SU";
GT.visual.shape_dstr = "ERO_5P85SU_D";
...
--GT.WS[ws].LN[1].BR[4] = {pos = {1.0, -0.8, 1.045}, drawArgument = 191 }; -- Changed by ERO5
...
GT.DisplayName = _('SAM SA-10B S-300PS "Grumble" TEL A');

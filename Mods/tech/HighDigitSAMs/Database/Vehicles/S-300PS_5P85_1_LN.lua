...
GT.visual.shape = "ERO_5P85SE";
GT.visual.shape_dstr = "ERO_5P85SE_D";
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.S_300PT);
...
GT.WS[ws].LN[1].depends_on_unit = {{{"S-300PS SA-10B 30N6 MAST tr"},},{{"S-300PS 30N6 TRAILER tr"},},};
...
-- GT.WS[ws].LN[1].BR[1] = {pos = {1.0, -0.8,-1.045}, drawArgument = 188 }; -- Changed by ERO
-- GT.WS[ws].LN[1].BR[2] = {pos = {1.0, 0.3, -0.614}, drawArgument = 189 }; -- Changed by ERO
-- GT.WS[ws].LN[1].BR[3] = {pos = {1.0, 0.3, 0.614}, drawArgument = 190 }; -- Changed by ERO
-- GT.WS[ws].LN[1].BR[4] = {pos = {1.0, -0.8, 1.045}, drawArgument = 191 }; -- Changed by ERO
GT.WS[ws].LN[1].BR[1] = {pos = {10.05, 0.216,-1.045}, drawArgument = 188 }; -- Changed by ERO
GT.WS[ws].LN[1].BR[2] = {pos = {10.05, 1.204,-0.614}, drawArgument = 189 }; -- Changed by ERO
GT.WS[ws].LN[1].BR[3] = {pos = {10.05, 1.204, 0.614}, drawArgument = 190 }; -- Changed by ERO
GT.WS[ws].LN[1].BR[4] = {pos = {10.05, 0.216, 1.045}, drawArgument = 191 }; -- Changed by ERO

GT.Name = "S-300PS 5P85_1_mod ln";
GT.DisplayName = _('SAM SA-10A S-300PT "Grumble" (5V55K) TEL A');
GT.DisplayNameShort = _("SA-10A");
GT.Rate = 10;

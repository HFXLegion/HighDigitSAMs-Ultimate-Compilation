...
GT.visual.shape = "ERO_55Zh6U_Nebo_U";
GT.visual.shape_dstr = "ERO_55Zh6U_Nebo_U_D";
...
GT.Name = "EWR 55G6U NEBO-U";
GT.DisplayName = _("EWR 55G6U Nebo-U");
GT.Rate = 100;

GT.Sensors = { RADAR = "EWR 55G6U NEBO-U" };

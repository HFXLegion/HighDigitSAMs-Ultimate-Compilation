...
GT.visual.shape = "ERO_9S15M2";
GT.visual.shape_dstr = "ERO_9S15M2_D";
...
for i = 1,15 do 
    ...
    GT.WS[ws].pos = {0,8,0}
	GT.WS[ws].angles = {
					{math.rad(180), math.rad(-180), math.rad(-15), math.rad(65)},
					};
    GT.WS[ws].omegaY = 3
    GT.WS[ws].omegaZ = 3
    GT.WS[ws].LN = 
...
GT.Name = "S-300V4 9S15MDE sr";
GT.DisplayName = _("SAM SA-23 S-300V4 9S15MDE Bill Board SR");

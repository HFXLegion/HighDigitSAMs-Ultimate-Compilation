...
GT.WS[ws].pos = {0,9,0};
GT.WS[ws].angles = {
					{math.rad(65), math.rad(-65),math.rad(0), math.rad(97)},
					};
...
GT.WS[ws].LN = {};
GT.WS[ws].LN[1] = {};
GT.WS[ws].LN[1].max_number_of_missiles_channels = {2, 1};
...
GT.WS[ws].LN[1].max_trg_alt = 75000;
...
GT.WS[ws].LN[1].sightIndicationMode	= 4;
...
GT.Name = "ELM2084_MMR_WLR";
GT.DisplayName = _("SAM IDF EL/M-2084WLR STR");
GT.Rate = 20;

GT.Sensors = {RADAR = "ELM2084_MMR_WLR" };

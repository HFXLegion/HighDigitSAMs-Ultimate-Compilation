...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.S_400_40N6);
...
GT.Name = "S-400 51P6A (40N6E) ln";
GT.DisplayName = _('SAM SA-21 S-400 "Growler" (40N6E) TEL C');
GT.DisplayNameShort = _("SA-21 TEL C");
GT.Rate = 10;

...
GT.visual.shape = "ERO_91N6E_SR";
GT.visual.shape_dstr = "ERO_91N6E_SR_D";
...
GT.Name = "S-400 91N6E sr";
GT.DisplayName = _("SAM SA-21 S-400 91N6E Big Bird SR");
GT.DisplayNameShort = _("SA-21 BB SR");
GT.Rate = 20;

GT.Sensors = { RADAR = "S-400 91N6E sr" };

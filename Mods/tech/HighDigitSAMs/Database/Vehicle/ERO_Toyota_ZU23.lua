...
set_recursive_metatable(GT.chassis, GT_t.CH_t.TOYOTACRUISER_ZU23);

GT.visual.shape = "ERO_TOYOTA_ZU23"
...
GT.Name = "ERO_ZU23_Toyota";
GT.DisplayName = _("AAA ZU-23 Toyota technical");
GT.Rate = 6;

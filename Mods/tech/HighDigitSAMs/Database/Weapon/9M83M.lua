...
local SA9M83M = {
	Name = SA9M83M,
	display_name = _('9M83M S-300VM (SA-23A Gladiator)'),
	display_name_short = _('9M83M S-300VM (SA-23A Gladiator)'),
	name = "SA9M83M",
	...
	ModelData = { 
		...
		0, 			300000,	160000, 	0, 			0, 			0, 			0, 			-- thrust, newtons
...
declare_weapon(SA9M83M)

GT_t.WS_t.Antey2500_9M83M = {} -- S-300VM Antey-2500 (9M83M)
GT_t.WS_t.Antey2500_9M83M.moveable = false
GT_t.WS_t.Antey2500_9M83M.angles = {
					{math.rad(180), math.rad(-180), math.rad(-90), math.rad(90)},
					};
GT_t.WS_t.Antey2500_9M83M.reference_angle_Z = math.rad(90)
GT_t.WS_t.Antey2500_9M83M.LN = {}
GT_t.WS_t.Antey2500_9M83M.LN[1] = {}
GT_t.WS_t.Antey2500_9M83M.LN[1].type = 4
GT_t.WS_t.Antey2500_9M83M.LN[1].distanceMin = 5000
GT_t.WS_t.Antey2500_9M83M.LN[1].distanceMax = 90000
GT_t.WS_t.Antey2500_9M83M.LN[1].ECM_K = 0.3;
GT_t.WS_t.Antey2500_9M83M.LN[1].reactionTime = 2
GT_t.WS_t.Antey2500_9M83M.LN[1].launch_delay = 1;
GT_t.WS_t.Antey2500_9M83M.LN[1].reflection_limit = 0.019;
GT_t.WS_t.Antey2500_9M83M.LN[1].sensor = {}
set_recursive_metatable(GT_t.WS_t.Antey2500_9M83M.LN[1].sensor, GT_t.WSN_t[0])
GT_t.WS_t.Antey2500_9M83M.LN[1].beamWidth = math.rad(1);
GT_t.WS_t.Antey2500_9M83M.LN[1].PL = {}
GT_t.WS_t.Antey2500_9M83M.LN[1].PL[1] = {}
GT_t.WS_t.Antey2500_9M83M.LN[1].PL[1].ammo_capacity = 4
GT_t.WS_t.Antey2500_9M83M.LN[1].PL[1].type_ammunition = SA9M83M.wsTypeOfWeapon;
GT_t.WS_t.Antey2500_9M83M.LN[1].PL[1].reload_time = 1000000; -- never during the mission
GT_t.WS_t.Antey2500_9M83M.LN[1].BR = { {pos = {0, 0, 0} } }
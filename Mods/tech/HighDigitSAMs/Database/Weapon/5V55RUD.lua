...
local SA5V55RUD = {
	...
	D_max = 33500.0, -- Maximum range firing at low altitude, in meters
	...
	Mach_max = 5.3, -- maximum Mach of the missile, needs headroom to account for G and drag
	...
	ModelData = { 
		...
		0.9, 		0, 		10.0, 		0, 			0, 			0, 			1000000000, -- time of stage, sec
		0, 			0, 		102.0, 		0, 			0, 			0, 			0, 			-- fuel flow rate, kg/sec
		0, 			0, 		245000, 	0, 			0, 			0, 			0, 			-- thrust, newtons
...
declare_weapon(SA5V55RUD)

GT_t.WS_t.S_300PS1 = {} -- S-300PS (SA-10D Growler)
GT_t.WS_t.S_300PS1.moveable = false
GT_t.WS_t.S_300PS1.angles = {
					{math.rad(180), math.rad(-180), math.rad(-90), math.rad(90)},
					};
GT_t.WS_t.S_300PS1.reference_angle_Z = math.rad(90)
GT_t.WS_t.S_300PS1.LN = {}
GT_t.WS_t.S_300PS1.LN[1] = {}
GT_t.WS_t.S_300PS1.LN[1].type = 4
GT_t.WS_t.S_300PS1.LN[1].distanceMin = 5000
GT_t.WS_t.S_300PS1.LN[1].distanceMax = 90000
GT_t.WS_t.S_300PS1.LN[1].ECM_K = 0.4;
GT_t.WS_t.S_300PS1.LN[1].reactionTime = 10
GT_t.WS_t.S_300PS1.LN[1].launch_delay = 3;
GT_t.WS_t.S_300PS1.LN[1].reflection_limit = 0.049;
GT_t.WS_t.S_300PS1.LN[1].sensor = {}
set_recursive_metatable(GT_t.WS_t.S_300PS1.LN[1].sensor, GT_t.WSN_t[0])
GT_t.WS_t.S_300PS1.LN[1].beamWidth = math.rad(1);
GT_t.WS_t.S_300PS1.LN[1].PL = {}
GT_t.WS_t.S_300PS1.LN[1].PL[1] = {}
GT_t.WS_t.S_300PS1.LN[1].PL[1].ammo_capacity = 4
GT_t.WS_t.S_300PS1.LN[1].PL[1].type_ammunition = SA5V55RUD.wsTypeOfWeapon;
GT_t.WS_t.S_300PS1.LN[1].PL[1].reload_time = 1000000; -- never during the mission
GT_t.WS_t.S_300PS1.LN[1].BR = { {pos = {0, 0, 0} } }
...
local SA5V55K = {
	...
	D_max = 24500.0, -- Maximum range firing at low altitude, in meters
	...
	Range_max = 47000.0, -- Max range in meters
	...
	ModelData = { 
		...
		45, --onboard power system operation time, sec
...
declare_weapon(SA5V55K)

GT_t.WS_t.S_300PT = {} -- S-300PS (SA-10B)
GT_t.WS_t.S_300PT.moveable = false
GT_t.WS_t.S_300PT.angles = {
					{math.rad(180), math.rad(-180), math.rad(-90), math.rad(90)},
					};
GT_t.WS_t.S_300PT.reference_angle_Z = math.rad(90)
GT_t.WS_t.S_300PT.LN = {}
GT_t.WS_t.S_300PT.LN[1] = {}
GT_t.WS_t.S_300PT.LN[1].type = 4
GT_t.WS_t.S_300PT.LN[1].distanceMin = 1000
GT_t.WS_t.S_300PT.LN[1].distanceMax = 47000
GT_t.WS_t.S_300PT.LN[1].ECM_K = 0.4;
GT_t.WS_t.S_300PT.LN[1].reactionTime = 10
GT_t.WS_t.S_300PT.LN[1].launch_delay = 3;
GT_t.WS_t.S_300PT.LN[1].reflection_limit = 0.049;
GT_t.WS_t.S_300PT.LN[1].sensor = {}
set_recursive_metatable(GT_t.WS_t.S_300PT.LN[1].sensor, GT_t.WSN_t[0])
GT_t.WS_t.S_300PT.LN[1].beamWidth = math.rad(1);
GT_t.WS_t.S_300PT.LN[1].PL = {}
GT_t.WS_t.S_300PT.LN[1].PL[1] = {}
GT_t.WS_t.S_300PT.LN[1].PL[1].ammo_capacity = 4
GT_t.WS_t.S_300PT.LN[1].PL[1].type_ammunition = SA5V55K.wsTypeOfWeapon;
GT_t.WS_t.S_300PT.LN[1].PL[1].reload_time = 1000000; -- never during the mission
GT_t.WS_t.S_300PT.LN[1].BR = { {pos = {0, 0, 0} } }